...
SECRET_KEY = 'django-insecure-travel-dost-major-project-hubballi-dharwad-secret-key'
...
# Uses InMemoryChannelLayer for easy standalone local execution on Windows.
